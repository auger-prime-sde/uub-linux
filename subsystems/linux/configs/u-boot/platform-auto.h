...
/* Board name */
#define XILINX_BOARD_NAME	uub-linux
#define CONFIG_HOSTNAME	XILINX_BOARD_NAME

/* processor - ps7_cortexa9_0 */
#define CONFIG_CPU_FREQ_HZ	333333344
#define CONFIG_ARMV7
...
#define CONFIG_SERVERIP	192.168.71.128
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"default_bootcmd=tftp ${netstart} ${kernel_img} && bootm ${netstart}\0" \
""
